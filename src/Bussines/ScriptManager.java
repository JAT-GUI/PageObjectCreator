 ...
 */
public class ScriptManager implements MyFile {
    String type;
    String name;
    String header;
    private String body;
    ...
    public ScriptManager(String name, String type, String rootPath, String sourcePath, String author) {
        this.name = name;
        this.type = type;
        this.packeage = obtener_package(rootPath, sourcePath);
        System.out.println(packeage);
        this.header = "/*\n"
                + " * " + name + ".java    " + format.format(new Date()) + "\n"
                + " * Generated by JAT-GUI\n"
                + " * JAT-GUI author : Brayam Machicado Vidangos\n"
                + " */\n" + values.kwPackage + packeage+ " ;\n"
    ...
    public String build_line(String name_property, String target, String type, boolean key, boolean button, boolean select) {
        ...
        if (select) {
            methods = methods + getSelectMethod(name_property) + values.br;
        }
        return methods;
    }
    ...
    private String getEnabledFunction(String name_property) {
        ...
        String comment = 
                ...
                + "	 */ \n";
        String res = 
                  "      public boolean is" + name_propertyMethods + "Enabled(){\n"
                + "		try{\n"
    ...
    private String getDisplayedFunction(String name_property) {
        ...
        String comment = 
                ...
                + "	 */ \n";
        String res = 
                  "      public boolean is" + name_propertyMethods + "Displayed(){\n"
                + "		try{\n"
                + "			WebElement element = findElement(" + name_property + ");\n"
    ...
    private String getClickMethod(String name_property) {
        ...
        String comment = 
                ...
                + "	 */ \n";
        String res = 
                  "      public void click" + name_propertyMethods + "(){\n"
                + "		try{\n"
                + "			WebElement element = findElement(" + name_property + ");\n"
                + "			element.click();\n"
                + "		}catch (Exception e){\n"
    ...
    private String getPutMethod(String name_property) {
        ...
        String comment = 
                ...
                + "	 */\n";
        String res = 
                  "	 public void enter" + name_propertyMethods + "Text(String text){\n"
                + "		try{\n"
                + "			WebElement element = findElement(" + name_property + ");\n"
                + "                     element.clear();\n"
    ...
    private String getSelectMethod(String name_property) {
        String name_propertyMethods = ((char) (name_property.charAt(0) - 32)) + name_property.substring(1);
        String comment = 
                  "      /**\n"
                + "	 * This function demonstrates select" + name_propertyMethods + "Text().\n"
                + "	 * <br>Function to select value into the " + name_propertyMethods + "\n"
                + "	 * @param value"
                + "	 * @returns none.\n"
                + "	 * @exception None.\n"
                + "	 * @author " + author + "\n"
                ...
                + "	 */		";
        String res = 
                  "      public void select" + name_propertyMethods + "(String value){\n"
                + "		try{\n"
                + "			WebElement element = findElement(" + name_property + ");\n"
                + "                     new Select(element).selectByVisibleText(value);\n"
                + "		}catch (Exception e){\n"
                + "			Reporter.log(\"Failed to select or locate the element: " + name_property + "\");\n"
                + "			e.printStackTrace();\n"
                + "		}\n"
                + "      }";
    ...
    public String iniciar_clase() {
        return values.kwPublic + values.kwClass + name + " " + values.kwExtends + "PageObjectPB" + " implements PageObjectPBI"+ values.lla + values.br;
    ...
    public String armar_constructor(String URL) {
        String salida = 
                  "\n"+
                  "             String URL = \""+URL+"\";\n"+
                  "             public " + name + " (WebDriver driver, String baseUrl){\n"
    ...
    public String declararEnPageFactory(){
        String nameVar = (name.substring(0,1).toLowerCase() +name.substring(1));
        return 
"               private "+name+" "+nameVar+";\n"+                
"               public "+name+" get"+name+"(){\n" +
"		if ("+nameVar+" == null) {\n" +
"			"+nameVar+" = new "+name+"(driver, baseUrl);\n" +
"		}\n" +
"		return "+nameVar+";\n" +
"               }\n"+
"\n}\n";
    ...
    public String declarar_variable(String var_name, String var_type, String var_path) {
        String var = "private String " + var_name + "= new ElementPath(ElementPath." + var_path + ",\"" + var_path + "\");\n" + values.br;
        return var;
    }
    ...
    /**
     * @param packeage the packeage to set
     */
    public void setPackeage(String packeage) {
        this.packeage = packeage;
    }

    public String addImport(String texto, String packeage) {
        int pos1 = texto.indexOf("import");
        String part1 = texto.substring(0, pos1);
        String part2 = texto.substring(pos1);
        String importText = part1 + packeage +"\n"+ part2;
        return importText;
    }
}
